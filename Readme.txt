Prosty program konsolowy w VB2022 pozwalający na wprowadzanie ocen uczniów szkoły podstawowej.
Oceny mogą być wprowadzane do pamięci (InMemory) lub do pliku (InFile). 
Zakres ocen:
- dla uczniów w wieku 6-9 lat oceny są wprowadzone literowa A – E i przeliczane liczbowo, gdzie A to 6, B-5, C-4, D-3, E-2 i F-1,
- dla uczniów w wieku 10-15 lat oceny z zakresu 1-6 jako liczby całkowite.
